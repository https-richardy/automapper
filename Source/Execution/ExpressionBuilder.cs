...
public static class ExpressionBuilder
{
    ...
    static readonly MethodCallExpression CheckContextCall = Expression.Call(typeof(ResolutionContext).GetStaticMethod(nameof(ResolutionContext.CheckContext)), ContextParameter);
