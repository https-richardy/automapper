...
/// Discovered during scanning assembly scanning for configuration when calling <see cref="O:HttpsRichardy.Mapping.IMapperConfigurationExpression.AddMaps"/>
/// </summary>
...
public sealed class AutoMapAttribute(Type sourceType) : Attribute
{
    ...
    /// <summary>
    /// Skip normal member mapping and convert using a <see cref="ITypeConverter{TSource,TDestination}"/> instantiated during HttpsRichardy.Mapping.
    /// </summary>
