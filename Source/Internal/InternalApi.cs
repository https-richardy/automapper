using HttpsRichardy.Mapping.Configuration.Conventions;
using HttpsRichardy.Mapping.Features;
using HttpsRichardy.Mapping.Internal.Mappers;
using HttpsRichardy.Mapping.QueryableExtensions.Impl;

namespace HttpsRichardy.Mapping.Internal;
...
public interface IGlobalConfigurationExpression : IMapperConfigurationExpression, IProfileExpressionInternal
{
    ...
    /// See <a href="https://automapper.readthedocs.io/en/latest/Understanding-your-HttpsRichardy.Mapping.html">the docs</a> for details.
    /// </summary>
...
public interface IGlobalConfiguration : IConfigurationProvider
{
    ...
    /// Useful to understand what exactly is happening during HttpsRichardy.Mapping.
    /// See <a href="https://automapper.readthedocs.io/en/latest/Understanding-your-HttpsRichardy.Mapping.html">the wiki</a> for details.
    /// </summary>
    ...
    /// <summary>
    /// Allows to enable null-value propagation for query HttpsRichardy.Mapping.
...
public interface IProfileExpressionInternal : IProfileExpression
{
    ...
    /// <summary>
    /// Disable method HttpsRichardy.Mapping. Use this if you don't intend to have AutoMapper try to map from methods.
    /// </summary>
    bool? MethodMappingEnabled { get; set; }
    /// <summary>
    /// Disable fields HttpsRichardy.Mapping. Use this if you don't intend to have AutoMapper try to map from/to fields.
    /// </summary>
